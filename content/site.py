...
BASE_URL = "https://www.bundang-barogo.example.com"
...
NAV = [
    ...
    ("지역별 안내", "/bundang/", [
        ("분당구 전체", "/bundang/"),
        ("분당동", "/bundang/bundang-dong/"),
        ("수내동", "/bundang/sunae-dong/"),
        ("정자동", "/bundang/jeongja-dong/"),
        ("서현동", "/bundang/seohyeon-dong/"),
        ("이매동", "/bundang/imae-dong/"),
        ("야탑동", "/bundang/yatap-dong/"),
        ("구미동", "/bundang/gumi-dong/"),
        ("금곡동", "/bundang/geumgok-dong/"),
        ("궁내동", "/bundang/gungnae-dong/"),
        ("동원동", "/bundang/dongwon-dong/"),
        ("백현동", "/bundang/baekhyeon-dong/"),
        ("삼평동", "/bundang/sampyeong-dong/"),
        ("판교동", "/bundang/pangyo-dong/"),
        ("운중동", "/bundang/unjung-dong/"),
        ("대장동", "/bundang/daejang-dong/"),
        ("석운동", "/bundang/seogun-dong/"),
        ("율동", "/bundang/yul-dong/"),
        ("하산운동", "/bundang/hasanun-dong/"),
    ]),
    ("지하철역별 안내", "/bundang/stations/", [
        ("역 전체", "/bundang/stations/"),
        ("야탑역", "/bundang/stations/yatap-station/"),
        ("이매역", "/bundang/stations/imae-station/"),
        ("서현역", "/bundang/stations/seohyeon-station/"),
        ("수내역", "/bundang/stations/sunae-station/"),
        ("정자역", "/bundang/stations/jeongja-station/"),
        ("미금역", "/bundang/stations/migeum-station/"),
        ("오리역", "/bundang/stations/ori-station/"),
        ("판교역", "/bundang/stations/pangyo-station/"),
        ("성남역", "/bundang/stations/seongnam-station/"),
    ]),
    ("테마별 안내", "/themes/", [
        ("전체 테마", "/themes/"),
        ("스웨디시", "/themes/swedish/"),
